...
class DetailParentAdapter(
    ...
    class DetailParentViewHolder(
        ...
        private val textItemCategory: TextView = itemBinding.textViewItemCategory
        private val recyclerChildDetail: RecyclerView = itemBinding.recyclerViewChildDetail
